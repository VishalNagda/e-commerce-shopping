...
function user_register(){
    ...
    if(name==''){
        jQuery('#name_error').html('Enter Name ')
        is_err='yes'
       
    }if(email==''){
        jQuery('#email_error').html('Enter Email ')
        is_err='yes'
    }if(mobile==''){
        jQuery('#mobile_error').html('Enter Mobile ')
        is_err='yes'
    } if(password==''){
    ...
    if(is_err==''){
        jQuery.ajax({
            ...
            if(result=='Inserted'){
                jQuery('#register_msg').html('Thank You For Register. Now Login')
            }
            }
        })
...
function user_login(){
   ...
   if(email==''){
        jQuery('#login_email_error').html('Enter Email ')
        is_err='yes'
    } if(password==''){
    ...
    if(is_err==''){
        jQuery.ajax({
            ...
            success:function(result){
            if(result=='wrong'){
                jQuery('#login_msg').html("Please Enter Vaild Login Detail");
            }
            if(result=='vaild'){
