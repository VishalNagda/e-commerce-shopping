                            ...
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="sort_product_drop('<?php echo $cat_id ?>','<?php echo SITE_PATH ?>')" id="sort_product_id">
                                        ...
                                        <option value='price_high' <?php echo $high_selected='selected' ?>>Sort by High To Low</option>
                                        <option value='price_low'<?php echo $low_selected='selected' ?>>Sort by Low To High</option>
                                        <option value='new'<?php echo $new_selected='selected' ?>>Sort by Newness</option>
                                        <option value='old'<?php echo $old_selected='selected' ?>>Sort by Oldness</option>
                                    </select>
                                </div>
