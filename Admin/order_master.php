                        ...
                        <div class="card-body--">
                           ...
                           <table class='table'>
                                        ...
                                        <tbody>
                                            ...
                                            $res=mysqli_query($con,"SELECT order_list.*,order_status.name as order_status_str FROM order_list,order_status where  order_list.order_status=order_status.id"); 
